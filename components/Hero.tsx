    ...
    <div className="w-full h-screen flex justify-center">
      <div className="flex flex-col gap-3 mt-20 px-8 items-center">
        <div className="max-w-5xl">
          ...
          <div className="flex gap-2 justify-center mt-2 record">
            <Link href={isAuthenticated ? "/videos" : "/sign-in"}>
              <button className="group primary-btn px-10 py-4">
                Get Started
        ...
        <div className="mt-5 rounded-2xl p-1 bg-black shadow-2xl shadow-pink-100">
          <Image
